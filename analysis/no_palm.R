# Final analyses for elevation seedling paper - NO PALMS 
...
ggsave(file="img_no_palm/spaghetti.pdf", plot=spaghetti, width=10, height=5)
...
ggsave(file="img_no_palm/box.pdf", plot=box, width=10, height=5)
...
fileConn <- file("img_no_palm/species_sample_loc.tex")
...
fileConn <- file("img_no_palm/species_elevcode_tally.tex")
...
ggsave(file="img_no_palm/mig.pdf", plot=mig, width=10, height=5)

# Site level environmental variables (Whitaker?)
fileConn <- file("img_no_palm/site_char.tex")
...
ggsave(file = "img_no_palm/ranges.pdf", plot = ranges_ggplot, width = 10, height = 5)
...
ggsave(file = "img_no_palm/traits_elev_scatter.pdf", plot = traits_elev_scatter, width = 10, height = 5)
...
ggsave(file = "img_no_palm/traits_elev_slopes.pdf", plot = traits_elev_slopes, width = 10, height = 5)
...
ggsave(file = "img_no_palm/comp_radius_fit.pdf", plot = comp_radius_fit, width = 10, height = 5)
...
fileConn <- file("img_no_palm/comp_radius.tex")
...
aberg_census_summ <- aberg_census %>%
  ...
  arrange(num) %>%
  mutate(id = seq(from =  length(.$num), to = 1, by = -1),
...
ggsave(file = "img_no_palm/rank_abund.pdf", plot = rank_abund, width = 10, height = 5)
...
ggsave(file="img_no_palm/single_pred_slope.pdf", plot=single_pred_slope, width=10, height=5)
...
ggsave(file="img_no_palm/single_pred_r2m.pdf", plot=single_pred_r2m, width=10, height=5)
...
ggsave(file = "img_no_palm/single_pred_daic.pdf", plot = single_pred_daic, width = 10, height = 5)
...
ggsave(file="img_no_palm/multi_pred_slope.pdf", plot=multi_pred_slope, width=10, height=5)
