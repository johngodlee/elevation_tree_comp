...
\centering
\caption{Estimated elevational migration rates of selected genera of which species are studied here. Migration rates are estimated using shifts in the centre of gravity of basal area as measured in the ABERG 1 Ha plot network.}
\label{fig:comp_radius_fit}
\end{figure}
